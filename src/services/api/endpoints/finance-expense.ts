...
export const financeExpenseApi = {
  async listAll(signal?: AbortSignal) {return adaptFinanceExpenseSnapshot(await apiRequest<FinanceExpenseListResponseDto>("/api/gpu_erp/finance/payment-outs", {signal}));},
