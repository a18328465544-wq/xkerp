...
test("mutation policy includes shared ERP writes and excludes read-only POST analysis", () => {
  ...
  assert.equal(isStateMutationPath("POST", "/api/ai/insights/refresh"), false);
